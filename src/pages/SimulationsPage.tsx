            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-white/[0.06] sticky top-0 z-10"
                ...
                <div className="flex items-center gap-2">
                  ...
                  <ShareMenu title={simulations.find(s => s.id === openSim)?.title || 'Simulation'} popupType="simulation" popupId={openSim} compact />
                  <motion.button
              ...
              <div ref={contentRef} className="p-6 md:p-8">
                <TextSelectionPopover
                  ...
                  source={simulations.find(s => s.id === openSim)?.title || 'Simulation'}
                  sourceType="simulation"
                  field={simulations.find(s => s.id === openSim)?.field}
                  sourceId={openSim}
                />
                <motion.h2
